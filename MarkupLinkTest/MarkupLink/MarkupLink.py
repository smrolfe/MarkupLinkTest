...
class MarkupLink(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.title = "MarkupLink"  # TODO: make this more human readable by adding spaces
        ...
        self.parent.contributors = ["Sara Rolfe (SCRI), Murat Maga (SCRI, UW)"]  # TODO: replace with "Firstname Lastname (Organization)"
